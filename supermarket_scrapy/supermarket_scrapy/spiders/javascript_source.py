...
class JavascriptSourceSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        name = sel.xpath(
            "/html/body/form/div[13]/div[2]/div[1]/div/div[1]/div[2]/div[2]/h1/text()"
        ).extract_first()
        ingredients = sel.xpath(
            "/html/body/form/div[13]/div[2]/div[1]/div/div[1]/div[4]/div[2]/ul/li/text()"
        ).extract()
        image_src = sel.xpath(
            "/html/body/form/div[13]/div[2]/div[1]/div/div[1]/div[2]/div[1]/img/@src"
        ).extract_first()
